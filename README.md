...
- 회원가입 진행 후 예약을 진행 할 수 있다.
    ...
    - 회원가입 진행시 작성했던 이메일을 통해서 인증 후 가입이 진행 된다.
        - 이메일 인증에는 Gmail을 사용여 SMTP를 활용합니다.
    - 이메일 인증은 1일 동안 유효하며 실패 시 진행이 불가능합니다.
- 로그인 실패
    - 회원가입시 작성했던 이메일 불일치
    - 비밀번호 불일치
- **주의사항**
...
- **예약 관리**
    ...
    **예약 취소**
    ...
    - 예약 취소 불가능 경우
        ...
        - 예약 시 등록했던 비밀번호가 불일치 할 경우
    - 관리자에 의해 업체 영업이 정지 될 경우 일괄적으로 예약이 취소 됩니다.
